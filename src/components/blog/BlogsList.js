...
// import productImage from '../../assets/images/a1b711fdb518b3bf71269fda28dcf4c1.jfif';
import { useSelector, useDispatch } from 'react-redux';
import { fetchAllBlogs, incrementViews } from '../../redux/blog/blogSlice';
import { Link } from 'react-router-dom';

export default function BlogsList() {
  const dispatch = useDispatch();
  const blogs = useSelector((state) => state.blog.blogPosts);
  const status = useSelector((state) => state.blog.allBlogsStatus);
  ...
  return (
    <>
          ...
          <div className="row bg-about">
            <div className=" col-lg-6">
              <div className="d-flex justify-content-center align-items-center h-100">
                <h1 className="text-white">Our Blog
                </h1>
              </div>
            </div>
            <div className="col-lg-6 bg-about2 p-5">
              <div className="d-flex justify-content-center flex-column  h-100 w-80">
                <h4 className='mb-4'>Diagnose Car Problems If You Don’t Know Much About Cars
                </h4>
                <p className="p-18">We provide a full range of front end mechanical repairs for all makes and models of cars, no matter the cause. This includes, We provide a full range of front end mechanical.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="d-flex justify-content-center row">
            <div className="col-lg-11 bg-secondary">
              <div className="row p-3 bg-white">
                <div className="col-md-4 px-0  h-100"><img alt='' className="img-fluid img-responsive product-image"
                  src={"/images/a1b711fdb518b3bf71269fda28dcf4c1.jfif"} /></div>
                <div className="col-md-8 d-flex flex-column justify-content-between">
                  <div className='d-flex justify-content-between align-items-center mt-2 mt-md-0 mb-2'>
                    <div className=''>
                      <span className='p-16 text-secondary me-3'>
                    ...
                    <div className='text-end'>
                      <span className='p-16 text-danger '>
                        FEATURED
                      </span>
                    </div>
                  </div>
                  ...
                  <p className=" mb-0 p-16 text-secondary">There are many We provide a full range of front end mechanical repairs for all makes and models of cars, no matter the cause. This includes, We provide a full range of front end mechanical.<br /><br />
                  </p>
                  <h6>Read more
                    <span className='ms-3'>
                      <svg width="51" height="16" viewBox="0 0 51 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M50.7071 8.70711C51.0976 8.31658 51.0976 7.68342 50.7071 7.29289L44.3431 0.928932C43.9526 0.538408 43.3195 0.538408 42.9289 0.928932C42.5384 1.31946 42.5384 1.95262 42.9289 2.34315L48.5858 8L42.9289 13.6569C42.5384 14.0474 42.5384 14.6805 42.9289 15.0711C43.3195 15.4616 43.9526 15.4616 44.3431 15.0711L50.7071 8.70711ZM0 9H50V7H0V9Z" fill="#1E1B1B" />
                      </svg>
                    </span>
                  </h6>
      ...
      {/* ---------------- */}
      <section className="py-5 px-md-0 px-3 ">
        <div className="container my-5">
          <div className="d-flex justify-content-center row">
            <div className="col-lg-11 px-0">
              <div className="row justify-content-start">
                {blogs?.length > 0 && blogs?.map((ele, index) => {
                  return (
                    <div key={ele?.id + index} className="col-lg-4 col-md-6 mb-5">
                      <Link onClick={() => handleIncrementViews(ele.id)} to={`/blog/${ele?.id}`} className="text-decoration-none text-dark" >
                        ...
                        <div className="card-body">
                          <div className='d-flex justify-content-between flex-wrap mt-3'>
                            ...
                            <span className='p-16 text-secondary '>
                              <span className=' me-2'>
                                <svg width="22" height="16" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M19.8698 6.962C20.3438 7.582 20.3438 8.419 19.8698 9.038C18.3768 10.987 14.7948 15 10.6128 15C6.4308 15 2.8488 10.987 1.3558 9.038C1.12519 8.74113 1 8.37592 1 8C1 7.62408 1.12519 7.25887 1.3558 6.962C2.8488 5.013 6.4308 1 10.6128 1C14.7948 1 18.3768 5.013 19.8698 6.962V6.962Z" stroke="#B8B8B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                  <path d="M10.6133 11C12.2701 11 13.6133 9.65685 13.6133 8C13.6133 6.34315 12.2701 5 10.6133 5C8.95643 5 7.61328 6.34315 7.61328 8C7.61328 9.65685 8.95643 11 10.6133 11Z" stroke="#B8B8B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                          ...
                          <h5 className="">{ele?.Title}</h5>
                          <p className="p-16 text-secondary mb-0">{ele?.Subtitle}</p>
                        </div>
                      </Link>
                    </div>
                  )
